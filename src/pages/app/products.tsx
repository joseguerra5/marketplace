    ...
    <div className="max-w-5xl m-auto">
      <div className="my-10">
        ...
        <span className="text-gray-300 text-sm font-light">
          Acesse e gerencie a sua lista de produtos á venda
        </span>
      </div>
      <div className="grid grid-cols-3 gap-6">
        <form
          ...
          className="gap-5 flex flex-col sticky top-5 col-span-1 bg-white rounded-lg p-6 h-fit"
        >
            ...
            render={({ field: { name, onChange, value, disabled } }) => {
              return (
                <div className="group flex items-center focus-within:text-orange-base">
                  ...
                  <button
                    className="bg-shape rounded-full aspect-square p-1 flex items-center"
                    type="button"
