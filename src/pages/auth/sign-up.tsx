      ...
      >
        ...
        <div className="rounded-lg bg-shape size-fit w-20 h-20">
          {imagePreview ? (
            ...
            <label
              htmlFor="avatarId"
              className="group w-full h-full  justify-center items-center flex relative"
            >
              <ImageUp
                className="text-orange-base absolute group-hover:text-orange-dark"
                width={24}
              />
              <input
                type="file"
        ...
        <button
          className="justify-between flex rounded-lg bg-orange-base border-transparent hover:bg-orange-dark text-white p-2 w-full"
